...
class BookingRepository extends BasicRepository
{
    ...
    protected $fieldSearchable = [
        'id', 'date','pitch_id','start_time','end_time'
    ];
     ...
     */
    public function findBy(Request $request, $pagination = false, $perPage = 10, $get = '',$column = ['*'])
    {
        return $this->all($request->all(), $column, [], [], [], [], [], $get, null, null, $pagination, $perPage);
    }
